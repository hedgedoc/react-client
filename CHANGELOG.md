...
- The use of `sequence` as code block language ([Why?](https://community.hedgedoc.org/t/frequently-asked-questions/190))
...
- Use KaTeX instead of MathJax. ([Why?](https://community.hedgedoc.org/t/frequently-asked-questions/190))
