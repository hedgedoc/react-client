...
export const OneClickEmbedding: React.FC<OneClickFrameProps> = ({ previewClassName, containerClassName, onImageFetch, loadingImageUrl, children, tooltip, hoverIcon }) => {
